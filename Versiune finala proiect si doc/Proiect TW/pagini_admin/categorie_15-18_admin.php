...
if(isset($_SESSION['username']) and isset(($_COOKIE['cont_de_administrator']))){
	...
	$conn=connect_to_db();
	setcookie("categorie", "location: ../pagini_admin/categorie_15-18_admin.php", time()+3600, '/');
		...
		<div id="main">
			...
			<div id="menubar">
				<ul id="menu">
					...
					<li class="current"><a href="categorie_15-18_admin.php">Categorie 15-18 ani</a></li>
				...
				<div class="sidebar_container">
					<div class="sidebar">
						<div class="sidebar_item">
							...
							<h2>Cuprins</h2><ul>';
								get_poveste_for_cuprins('Categorie 15-18 ani',$conn);
