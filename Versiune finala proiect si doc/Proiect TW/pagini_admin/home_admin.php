...
{	
	setcookie('value_buton',1,time()-3600,'/');//header('location: home.html');
echo'
<!DOCTYPE html>
...
<html lang="ro">
	...
	<body>
		<div id="main">
			...
			<div id="menubar">
				<ul id="menu">
					<li class="current"><a  href="home_admin.php">Home</a></li>
			...
			echo '
							...
							<a id="A" href="load_admin.php"  title="Upload">
							<img width="18" height="18" alt="Eroare incarcare imagine" src="../imagini/sageata_upload.jpg"/>
							</a>
							
							<a id="load" href="load_admin.php">Incarca o poveste</a>
							</br>
							</br>
							<a id="A" href="delete.php"  title="Delete">
							<img width="18" height="18" alt="Eroare incarcare imagine" src="../imagini/delete.png"/>
							</a>
							
							<a id="delete" href="delete.php">Sterge o poveste</a>
							</br>
							</br>
							<div id="logout">
