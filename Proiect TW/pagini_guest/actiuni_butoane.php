...
{
	$fragment_initial= 1;
	$update_fragment="update semncarte set id_fragment='$fragment_initial' where user='$retine_username' and id_poveste='$id_poveste_cautata'";
...
{	
	...
	$update_fragment="update semncarte set id_fragment='$fragment_final' where user='$retine_username' and id_poveste='$id_poveste_cautata'";
	$query  = mysqli_query($con,$update_fragment);
	header( 'location: ../pagini_guest/rezultate_cautare.php');
}			
...
if (isset($_POST["fragment_urmator"]))
{
	if($fragment_curent!=$id_fragment_final)
	{
		...
		$update_fragment="update semncarte set id_fragment='$fragment_curent' where user='$retine_username' and id_poveste='$id_poveste_cautata'";
		$query  = mysqli_query($con,$update_fragment);
	}
	header( 'location: ../pagini_guest/rezultate_cautare.php');
}		
